(function (window) {
    ...
    p.bbM = function (need) {
        ...
        this.bb.graphics.beginFill('#e50000').setStrokeStyle(4).beginStroke('#ff0154').drawRect(0, 0, 130, 60); // Customize the button appearance
        this.bb.y = -150;
        this.bb.alpha = 1;

        this.label = new createjs.Text('DON\'T\n CLICK ME', '20px Barkentina', '#ffeb00'); // Set the button's label text, font, and color
        this.label.textAlign = 'center';
        this.label.textBaseline = 'middle';
        this.label.x = 65; // Set the label's position relative to the button's dimensions
        this.label.y = -130;
